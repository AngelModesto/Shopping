...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Juan", "Zuluaga", "zulu@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "ZuluProfilePic.jpg", UserType.Admin);
            await CheckUserAsync("3030", "Brad", "Pitt", "brad@yopmail.com", "656 524 1514", "Parajes del sol 456", "BradPittProfilePic.jpg", UserType.User);
            await CheckUserAsync("4040", "Angelina", "Jolie", "angelina@yopmail.com", "656 544 8978", "Campestre 5465", "AngeJolieProfilePic.jpg", UserType.User);
            await CheckUserAsync("5050", "Liv", "Tyler", "liv@yopmail.com", " 661 545 7889", "Calle Frambuesa 4354", "LvTylerProfilePic.jpg", UserType.User);
            await CheckUserAsync("6060", "Angel", "Modesto", "angel@yopmail.com", "656 500 0000", "Calle cielo", "ProfilePic.jpg", UserType.User);
            await CheckUserAsync("2020", "Ledys", "Bedoya", "ledys@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "ledysPicPorfile.jpg", UserType.User);
